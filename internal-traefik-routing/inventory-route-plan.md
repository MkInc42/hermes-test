...
| Hermes dashboard / Kanban | `0.0.0.0` | **9119** | `hermes dashboard ... --host 0.0.0.0`; the native route redirects to `/login`, which returns 404 under the routed hostname | Reserved/disabled for this phase: no separate proxy auth was observed and the routed login flow is not usable. |
